...
public class Lab2 {
	...
	public static void decomposeMoney() {
		...
		JOptionPane.showMessageDialog(null, Integer.toString(monValues[3]) + " grands\n" + Integer.toString(monValues[2]) + " benjamins\n" + Integer.toString(monValues[1]) + " sawbucks\n" + Integer.toString(monValues[0]) + " bucks");
	}
